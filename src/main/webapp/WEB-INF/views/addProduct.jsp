                    ...
                    <section>
                        <form:form modelAttribute="newProduct" class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-lg-2" for="brand">Brand: </label>
                                    <div class="col-lg-10">
                                        <form:input id="brand" path="brand" type="text" class="form:input-large" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-lg-2" for="grossValue">Gross value: </label>
                                    <div class="col-lg-10">
                                        <form:input id="grossValue" path="grossValue" type="number" class="form:input-large" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-lg-2 col-lg-2" for="netValue">Net value: </label>
                                    <div class="col-lg-10">
                                        <form:input id="netValue" path="netValue" type="number" class="form:input-large" />
                                    </div>
                                </div>
                                <div class="form-group">
